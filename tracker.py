...
class Track(object):
    ...
    def __init__(self, prediction, trackIdCount):
        ...
        # print("prediction",prediction)  # predicted centroids (x,y)
...
class Tracker(object):
    ...
    def Update(self, detections):
        ...
        for i in range(int(len(self.tracks))):
            for j in range(int(len(detections))):
                try:
                    diff = self.tracks[i].prediction - detections[j]
                    #print("prediction",self.tracks[i].prediction,"detections",detections[j],end=" ")
